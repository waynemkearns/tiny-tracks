...
import { Baby, Feed, Nappy, SleepSession, HealthRecord } from "@/types/api";
          ...
          <CardContent className="space-y-3">
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked: CheckedState) => setIncludeFeeds(checked === true)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked: CheckedState) => setIncludeNappies(checked === true)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked: CheckedState) => setIncludeSleep(checked === true)}
              />
            ...
            <div className="flex items-center space-x-2">
              <Checkbox
                ...
                onCheckedChange={(checked: CheckedState) => setIncludeHealth(checked === true)}
              />
